...
func TestParseDomain(t *testing.T) {
	...
	testParseDomain(t, "gophers.in.space.museum", &Host{Hostname: "gophers.in.space.museum", Domain: "space", Management: ManagementICANN, Subdomains: []string{"gophers", "in"}, TopLevelDomains: []string{"museum"}, Type: HostnameTypeDomain}, nil)
	...
	testParseDomain(t, "foo.blogspot.co.uk", &Host{Hostname: "foo.blogspot.co.uk", Domain: "blogspot", Management: ManagementICANN, Subdomains: []string{"foo"}, TopLevelDomains: []string{"co", "uk"}, Type: HostnameTypeDomain}, nil)
